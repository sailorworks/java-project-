...
<%
	...
	String artistName = request.getParameter("artistButton");    
...
<body>
    <nav>
        <ul>
            <li>Musify</li>                 <!--navigation bar-->
            <li><a style="text-decoration:none;color:white;" href="/Music_Player/frontpage.jsp">Home</a></li>
    		<li>
    ...
    <div class="containernew">
        ...
        <table class="table">
			...
			String sql ="SELECT * FROM onlytable WHERE artistName='"+artistName+"' ";
